  ...
  return (
    <div className="space-y-10">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <StatCard label="Celkem" value={stats.total} sublabel="Všechny přijaté dotazy" />
        <StatCard label="Čeká na zpracování" value={stats.pending} sublabel="Důležité vyřídit jako první" />
        <StatCard label="Vyřízeno" value={stats.processed} sublabel="Uzavřené poptávky" />
      </section>
